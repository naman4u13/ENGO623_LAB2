...
public class MainApp {
	...
	public static void main(String args[]) {
		try {
			...
			File output = new File("C:\\Users\\naman.agarwal\\Documents\\EclipseProjects\\ENGO_623_LAB2\\src\\main\\resources\\result.txt");
			PrintStream stream;
			stream = new PrintStream(output);
			System.setOut(stream);
			ArrayList<double[]> ltn_down = Parser.getLTNData("x_LN100_down.ins");
			ArrayList<double[]> ltn_up = Parser.getLTNData("x_LN100_up.ins");
			ArrayList<double[]> mems_down = Parser.getMEMSData("x_adi_down.txt");
			ArrayList<double[]> mems_up = Parser.getMEMSData("x_adi_up.txt");
